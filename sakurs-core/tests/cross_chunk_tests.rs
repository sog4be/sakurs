...
use sakurs_core::domain::{
    cross_chunk::{
        ChunkMetadata, CrossChunkResolver, CrossChunkValidator, EnhancedAbbreviationState,
        EnhancedPartialState, EnclosureStateTracker, ValidationResult,
    },
...
fn test_cross_chunk_abbreviation_detection() {
    ...
    assert!(enhanced1.enhanced_abbreviation.is_cross_chunk_abbreviation(&enhanced2.enhanced_abbreviation));
    ...
    assert_eq!(result, ValidationResult::Invalid("Cross-chunk abbreviation detected".to_string()));
}
