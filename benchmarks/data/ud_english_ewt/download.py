        ...
        for attempt in range(max_retries):
            try:
                ...
                session.headers.update({
                    'User-Agent': 'sakurs-benchmarks/1.0 (research-tool)'
                })
                ...
                with open(archive_path, 'wb') as f, tqdm(
                    ...
                    for chunk in response.iter_content(chunk_size=1024 * 1024):  # 1MB chunks for better performance
                        if chunk:
                            f.write(chunk)
                ...
                if archive_path.stat().st_size == total_size:
                    ...
                    click.echo(f"⚠️  Download incomplete, retrying...")
                ...
                if attempt == max_retries - 1:
                    raise e
                click.echo(f"⏳ Waiting 30 seconds before retry...")
                import time
                time.sleep(30)
