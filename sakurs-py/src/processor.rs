...
impl PyProcessor {
    ...
    fn process(&self, text: &str, threads: Option<usize>, py: Python) -> PyResult<PyProcessingResult> {
    ...
    #[pyo3(signature = (text, threads=None))]
    pub fn sentences(&self, text: &str, threads: Option<usize>, py: Python) -> PyResult<Vec<String>> {
